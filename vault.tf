...
resource "hcp_vault_cluster" "learn_hcp_vault" {
  ...
  audit_log_config {
    ...
    grafana_endpoint = var.grafana_endpoint_logs
    grafana_user     = var.grafana_user_logs
    grafana_password = var.grafana_password
  }

  # Metrics configuration for the Vault cluster
  metrics_config {
    grafana_endpoint = var.grafana_endpoint_metrics
    grafana_user     = var.grafana_user_metrics
    grafana_password = var.grafana_password
  }
}
